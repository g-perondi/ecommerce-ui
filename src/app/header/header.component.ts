  ...
  template: `
    <header class="text-zinc-200">
      ...
      <nav class="sticky flex top-0 bg-gradient-to-r from-sky-900 via-pink-700 to-amber-600 z-10">
        ...
        <div class="block md:hidden ml-auto pr-4 my-auto" (click)="onClickMobileMenu()" >
          ...
          <div
            *ngIf="mobileMenuOpen"
            class="absolute top-[60px] bg-gradient-to-r from-sky-900 via-pink-700 to-amber-600 w-full left-0">
